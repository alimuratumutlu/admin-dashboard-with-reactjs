        ...
        <div class="slimscroll-menu" id="remove-scroll">
          ...
          <div id="sidebar-menu">
            <ul class="metismenu" id="side-menu">
              ...
              <MenuItem arrow="false" icon="fi-air-play" title="Güncel Durum" />

              <MenuItem
                arrow="true"
                icon="fi-layers"
                title="Slider"
                menu={this.state.sliderMenu}
              />

              <li>
                <a href="javascript: void(0);">
                  <i class="fi-mail" />
                  <span> Email </span> <span class="menu-arrow" />
                </a>
              ...
              <li>
                <a href="javascript: void(0);">
                  <i class="fi-layout" />
                  <span> Layouts </span> <span class="menu-arrow" />
                </a>
                <ul class="nav-second-level" aria-expanded="false">
                  <li>
              ...
              <li>
                <a href="javascript: void(0);">
                  <i class="fi-briefcase" /> <span> UI Elements </span>{" "}
              ...
              <li>
                <a href="widgets.html">
                  <i class="fi-command" /> <span> Widgets </span>
                </a>
              </li>

              <li>
                <a href="javascript: void(0);">
                  <i class="fi-bar-graph-2" />
                  <span> Charts </span> <span class="menu-arrow" />
                </a>
                <ul class="nav-second-level" aria-expanded="false">
                  <li>
              ...
              <li>
                <a href="javascript: void(0);">
                  <i class="fi-box" />
                  <span> Icons </span> <span class="menu-arrow" />
                </a>
                <ul class="nav-second-level" aria-expanded="false">
                  <li>
              ...
              <li>
                <a href="javascript: void(0);">
                  <i class="fi-paper" /> <span> Tables </span>{" "}
                  <span class="menu-arrow" />
                </a>
                <ul class="nav-second-level" aria-expanded="false">
                  <li>
              ...
              <li>
                <a href="javascript: void(0);">
                  <i class="fi-location-2" /> <span> Maps </span>{" "}
                  <span class="menu-arrow" />
                </a>
                <ul class="nav-second-level" aria-expanded="false">
                  <li>
              ...
              <li>
                <a href="javascript: void(0);">
                  <i class="fi-paper-stack" />
                  <span> Pages </span> <span class="menu-arrow" />
                </a>
                <ul class="nav-second-level" aria-expanded="false">
                  <li>
              ...
              <li>
                <a href="javascript: void(0);">
                  <i class="fi-share" /> <span> Multi Level </span>{" "}
                  <span class="menu-arrow" />
                </a>
                <ul class="nav-second-level nav" aria-expanded="false">
                  ...
                  <li>
                    <a href="javascript: void(0);" aria-expanded="false">
                      Level 1.2 <span class="menu-arrow" />
                    </a>
